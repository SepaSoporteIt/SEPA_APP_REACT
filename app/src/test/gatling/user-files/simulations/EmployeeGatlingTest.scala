...
class EmployeeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .repeat(2) {
            ...
            .get("/services/sepaapp/api/employees")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new employee")
            .post("/services/sepaapp/api/employees")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                ...
                , "tlf":"SAMPLE_TEXT"
                , "tipo":null
                , "matNumber":"SAMPLE_TEXT"
                , "cuit":"SAMPLE_TEXT"
                , "addressDirection":"SAMPLE_TEXT"
                , "addressNumber":"SAMPLE_TEXT"
                , "floor":"SAMPLE_TEXT"
                , "departament":"SAMPLE_TEXT"
                , "degree":"SAMPLE_TEXT"
                , "localidad":"SAMPLE_TEXT"
                , "partido":"SAMPLE_TEXT"
                , "especializacion":"SAMPLE_TEXT"
                , "celular":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/sepaapp${new_employee_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employee")
            .delete("/services/sepaapp${new_employee_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
