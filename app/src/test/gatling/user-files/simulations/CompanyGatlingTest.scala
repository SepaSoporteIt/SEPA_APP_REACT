...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .get("/services/sepaapp/api/companies")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new company")
            .post("/services/sepaapp/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
                ...
                , "isSubscripted":null
                , "comment":"SAMPLE_TEXT"
                , "fantasyName":"SAMPLE_TEXT"
                , "postalCode":"SAMPLE_TEXT"
                , "tlf":"SAMPLE_TEXT"
                , "internalTlf":"SAMPLE_TEXT"
                , "contact":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/sepaapp${new_company_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created company")
            .delete("/services/sepaapp${new_company_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
