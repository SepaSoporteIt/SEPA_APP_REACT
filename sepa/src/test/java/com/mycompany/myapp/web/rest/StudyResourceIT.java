...
import com.mycompany.myapp.repository.search.StudySearchRepository;
...
public class StudyResourceIT {
     ...
     *
     * @see com.mycompany.myapp.repository.search.StudySearchRepositoryMockConfiguration
     */
    @Autowired
    private StudySearchRepository mockStudySearchRepository;
    ...
    public void setup() {
        ...
        final StudyResource studyResource = new StudyResource(studyRepository, mockStudySearchRepository);
    ...
    public void createStudy() throws Exception {
        ...
        verify(mockStudySearchRepository, times(1)).save(testStudy);
    }
    ...
    public void createStudyWithExistingId() throws Exception {
        ...
        // Validate the Study in Elasticsearch
        verify(mockStudySearchRepository, times(0)).save(study);
    }
    ...
    public void deleteStudy() throws Exception {
        ...
        // Validate the Study in Elasticsearch
        verify(mockStudySearchRepository, times(1)).deleteById(study.getId());
    }
    ...
    public void searchStudy() throws Exception {
        // Initialize the database
        studyRepository.saveAndFlush(study);
        when(mockStudySearchRepository.search(queryStringQuery("id:" + study.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(study), PageRequest.of(0, 1), 1));
        // Search the study
