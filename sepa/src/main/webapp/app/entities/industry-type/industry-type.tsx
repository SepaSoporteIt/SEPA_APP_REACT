...
import { getSearchEntities, getEntities } from './industry-type.reducer';
import { IIndustryType } from 'app/shared/model/industry-type.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';

export interface IIndustryTypeProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export interface IIndustryTypeState extends IPaginationBaseState {
  search: string;
}

export class IndustryType extends React.Component<IIndustryTypeProps, IIndustryTypeState> {
  state: IIndustryTypeState = {
    search: '',
  ...
  render() {
    const { industryTypeList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="industry-type-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="sepaApp.industryType.home.createLabel">Create a new Industry Type</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('sepaApp.industryType.home.search')}
                  />
        ...
        <div className="table-responsive">
          {industryTypeList && industryTypeList.length > 0 ? (
            <Table responsive aria-describedby="industry-type-heading">
              ...
              <tbody>
                {industryTypeList.map((industryType, i) => (
                  <tr key={`entity-${i}`}>
                    <td>
                    ...
                    <td className="text-right">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`${match.url}/${industryType.id}/edit`} color="primary" size="sm">
                          <FontAwesomeIcon icon="pencil-alt" />{' '}
                          <span className="d-none d-md-inline">
                            <Translate contentKey="entity.action.edit">Edit</Translate>
                          </span>
                        </Button>
                        <Button tag={Link} to={`${match.url}/${industryType.id}/delete`} color="danger" size="sm">
                          <FontAwesomeIcon icon="trash" />{' '}
                          <span className="d-none d-md-inline">
...
const mapStateToProps = ({ industryType }: IRootState) => ({
  industryTypeList: industryType.entities,
  totalItems: industryType.totalItems
});
