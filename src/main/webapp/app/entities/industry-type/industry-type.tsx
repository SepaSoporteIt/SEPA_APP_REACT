...
import { getEntities } from './industry-type.reducer';
...
export const IndustryType = (props: IIndustryTypeProps) => {
  ...
  const { industryTypeList, match, loading, totalItems } = props;
  return (
    <div>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${industryType.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${industryType.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
...
export default connect(mapStateToProps, mapDispatchToProps)(IndustryType);
