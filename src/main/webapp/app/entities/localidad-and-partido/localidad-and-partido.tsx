...
import { getEntities } from './localidad-and-partido.reducer';
...
export const LocalidadAndPartido = (props: ILocalidadAndPartidoProps) => {
  ...
  return (
    <div>
      <h2 id="localidad-and-partido-heading">
        <Translate contentKey="sepaApp.localidadAndPartido.home.title">Localidad And Partidos</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="sepaApp.localidadAndPartido.home.createLabel">Create new Localidad And Partido</Translate>
        </Link>
      </h2>
        ...
        {localidadAndPartidoList && localidadAndPartidoList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="sepaApp.localidadAndPartido.home.notFound">No Localidad And Partidos found</Translate>
            </div>
          )
        )}
      </div>
